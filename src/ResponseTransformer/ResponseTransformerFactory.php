...
use AliexApi\ResponseTransformer\ResponseTransformerInterface;
...
class ResponseTransformerFactory
{
    ...
    public static function createResponseTransformer(ConfigInterface $config)
    {
        ...
        if ($reflectionClass->implementsInterface('\\AliexApi\\ResponseTransformer\\ResponseTransformerInterface')) {
